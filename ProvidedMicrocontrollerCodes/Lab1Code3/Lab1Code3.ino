/*
 * * This code measures 6Hz data with 8G from the Sparkfun Accelerometer
...
void loop() {
  if (accel.available()) {      // Wait for new data from accelerometer
    ...
    Serial.print(double(accel.getX())/256);
    Serial.print("\t");
    Serial.print(double(accel.getY())/256);
    Serial.print("\t");
